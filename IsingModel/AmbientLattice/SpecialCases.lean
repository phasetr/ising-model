...
ContinuousAt + DifferentiableAt wrappers (ambient).
Each derived via `.continuousAt` / `.differentiableAt` from the
existing whole-ℝ wrapper. -/
...
theorem partitionFunctionAlongExhaustion_continuousAt_beta_h_zero
    ...
    ContinuousAt (fun β' : ℝ =>
      partitionFunctionAlongExhaustion G Λ ⟨J, 0, β'⟩ n) β :=
  (partitionFunctionAlongExhaustion_continuous_beta_h_zero G Λ J n).continuousAt
...
theorem partitionFunctionAlongExhaustion_continuousAt_J_h_zero
    ...
    ContinuousAt (fun J' : ℝ =>
      partitionFunctionAlongExhaustion G Λ ⟨J', 0, β⟩ n) J :=
  (partitionFunctionAlongExhaustion_continuous_J_h_zero G Λ β n).continuousAt
...
theorem partitionFunctionAlongExhaustion_differentiableAt_beta_h_zero
    ...
    DifferentiableAt ℝ (fun β' : ℝ =>
      partitionFunctionAlongExhaustion G Λ ⟨J, 0, β'⟩ n) β :=
  (partitionFunctionAlongExhaustion_differentiable_beta_h_zero G Λ J n).differentiableAt
...
theorem partitionFunctionAlongExhaustion_differentiableAt_J_h_zero
    ...
    DifferentiableAt ℝ (fun J' : ℝ =>
      partitionFunctionAlongExhaustion G Λ ⟨J', 0, β⟩ n) J :=
  (partitionFunctionAlongExhaustion_differentiable_J_h_zero G Λ β n).differentiableAt
...
theorem partitionFunctionAlongExhaustion_continuousAt_beta_general_h
    ...
    ContinuousAt (fun β' : ℝ =>
      partitionFunctionAlongExhaustion G Λ ⟨J, h, β'⟩ n) β :=
  (partitionFunctionAlongExhaustion_continuous_beta_general_h G Λ J h n).continuousAt
...
theorem partitionFunctionAlongExhaustion_continuousAt_J_general_h
    ...
    ContinuousAt (fun J' : ℝ =>
      partitionFunctionAlongExhaustion G Λ ⟨J', h, β⟩ n) J :=
  (partitionFunctionAlongExhaustion_continuous_J_general_h G Λ β h n).continuousAt
...
theorem partitionFunctionAlongExhaustion_differentiableAt_beta_general_h
    ...
    DifferentiableAt ℝ (fun β' : ℝ =>
      partitionFunctionAlongExhaustion G Λ ⟨J, h, β'⟩ n) β :=
  (partitionFunctionAlongExhaustion_differentiable_beta_general_h G Λ J h n).differentiableAt
...
theorem partitionFunctionAlongExhaustion_differentiableAt_J_general_h
    ...
    DifferentiableAt ℝ (fun J' : ℝ =>
      partitionFunctionAlongExhaustion G Λ ⟨J', h, β⟩ n) J :=
  (partitionFunctionAlongExhaustion_differentiable_J_general_h G Λ β h n).differentiableAt
...
theorem partitionFunctionAlongExhaustion_continuousAt_h
    ...
    ContinuousAt (fun h' : ℝ =>
      partitionFunctionAlongExhaustion G Λ ⟨J, h', β⟩ n) h :=
  (partitionFunctionAlongExhaustion_continuous_h G Λ J β n).continuousAt
...
theorem partitionFunctionAlongExhaustion_differentiableAt_h
    ...
    DifferentiableAt ℝ (fun h' : ℝ =>
      partitionFunctionAlongExhaustion G Λ ⟨J, h', β⟩ n) h :=
  (partitionFunctionAlongExhaustion_differentiable_h G Λ J β n).differentiableAt
...
theorem partitionFunctionAlongExhaustion_continuousAt_joint
  ...
  (partitionFunctionAlongExhaustion_continuous_joint G Λ n).continuousAt
...
theorem partitionFunctionAlongExhaustion_differentiableAt_joint
    ...
    DifferentiableAt ℝ (fun q : ℝ × ℝ × ℝ =>
      partitionFunctionAlongExhaustion G Λ ⟨q.2.1, q.2.2, q.1⟩ n) p :=
  (partitionFunctionAlongExhaustion_differentiable_joint G Λ n).differentiableAt
...
theorem freeEnergyAlongExhaustion_continuousAt_beta
    ...
    ContinuousAt (fun β' : ℝ =>
      freeEnergyAlongExhaustion G Λ ⟨J, h, β'⟩ n) β :=
  (freeEnergyAlongExhaustion_continuous_beta G Λ J h n).continuousAt
...
theorem freeEnergyAlongExhaustion_differentiableAt_beta
    ...
    DifferentiableAt ℝ (fun β' : ℝ =>
      freeEnergyAlongExhaustion G Λ ⟨J, h, β'⟩ n) β :=
  (freeEnergyAlongExhaustion_differentiable_beta G Λ J h n).differentiableAt
...
theorem freeEnergyAlongExhaustion_continuousAt_field
    ...
    ContinuousAt (fun h' : ℝ =>
      freeEnergyAlongExhaustion G Λ ⟨J, h', β⟩ n) h :=
  (freeEnergyAlongExhaustion_continuous_field G Λ J β n).continuousAt
...
theorem freeEnergyAlongExhaustion_differentiableAt_field
    ...
    DifferentiableAt ℝ (fun h' : ℝ =>
      freeEnergyAlongExhaustion G Λ ⟨J, h', β⟩ n) h :=
  (freeEnergyAlongExhaustion_differentiable_field G Λ J β n).differentiableAt
...
theorem freeEnergyAlongExhaustion_continuousAt_J
    ...
    ContinuousAt (fun J' : ℝ =>
      freeEnergyAlongExhaustion G Λ ⟨J', h, β⟩ n) J :=
  (freeEnergyAlongExhaustion_continuous_J G Λ h β n).continuousAt
...
theorem freeEnergyAlongExhaustion_differentiableAt_J
    ...
    DifferentiableAt ℝ (fun J' : ℝ =>
      freeEnergyAlongExhaustion G Λ ⟨J', h, β⟩ n) J :=
  (freeEnergyAlongExhaustion_differentiable_J G Λ h β n).differentiableAt
...
theorem freeEnergyAlongExhaustion_continuousAt_joint
  ...
  (freeEnergyAlongExhaustion_continuous_joint G Λ n).continuousAt
