...
/-!
# Per-stage complex analyticity wrappers: CompactCoverPatches

Consolidated `CompactCoverPatches` wrappers for the GJ §17.5.2 / §4.6
...
/-!
# Branch Ascoli compact-open split — finite-cover compact-open patches
...
This compatibility module re-exports the split branch Ascoli compact-open
compact-cover layer.
-/
