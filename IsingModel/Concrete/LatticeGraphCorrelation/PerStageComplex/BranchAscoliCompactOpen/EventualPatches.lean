...
Consolidated `EventualPatches` wrappers for the GJ §17.5.2 / §4.6
...
/-!
# Branch Ascoli compact-open split — pointwise-normalised compact-open patch
...
/-!
# Branch Ascoli compact-open split — eventual patch re-exports

This compatibility module re-exports the split branch Ascoli compact-cover and
eventual patch wrappers that were previously reachable through this import path.
-/
