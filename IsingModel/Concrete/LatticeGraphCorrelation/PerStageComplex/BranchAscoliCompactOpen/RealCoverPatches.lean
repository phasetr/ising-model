...
/-!
# Per-stage complex analyticity wrappers: RealCoverPatches

Consolidated `RealCoverPatches` wrappers for the GJ §17.5.2 / §4.6
...
/-!
# Branch Ascoli compact-open split — finite Lee-Yang cover package
...
/-!
# Branch Ascoli compact-open split — finite real-cover compact-open patches

This compatibility module re-exports the split branch Ascoli real-cover layer.
-/
