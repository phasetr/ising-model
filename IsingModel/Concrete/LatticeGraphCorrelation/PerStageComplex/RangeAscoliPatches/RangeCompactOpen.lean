...
/-!
# Per-stage complex analyticity wrappers: RangeCompactOpen

Consolidated `RangeCompactOpen` wrappers for the GJ §17.5.2 / §4.6
...
Compatibility module re-exporting the split range-closure compact-open wrapper
endpoints.
-/
...
Compatibility module re-exporting the split relatively compact range wrapper
endpoints.
-/

/-!
# ℤ^d range compact-open patch wrappers compatibility module

This compatibility module re-exports the range compact-open wrapper layer split
under `PerStageComplex.RangeAscoliPatches.RangeCompactOpen`.
-/
