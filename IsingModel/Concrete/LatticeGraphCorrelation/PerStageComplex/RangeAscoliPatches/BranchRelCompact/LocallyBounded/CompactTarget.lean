import IsingModel.Concrete.LatticeGraphCorrelation.PerStageComplex.RangeAscoliPatches.BranchRelCompact.LocallyBounded.Core

/-!
# ℤ^d branch locally bounded relatively compact compact-target wrappers

This module contains the compact-target branch locally bounded relatively
compact wrapper endpoint.
-/
