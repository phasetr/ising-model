import IsingModel.Concrete.LatticeGraphCorrelation.PerStageComplex.RangeAscoliPatches.BranchRelCompact.NormBounded.Core

/-!
# ℤ^d branch norm-bounded relatively compact compact-target wrappers

This module contains the compact-target branch norm-bounded relatively compact
wrapper endpoint.
-/
