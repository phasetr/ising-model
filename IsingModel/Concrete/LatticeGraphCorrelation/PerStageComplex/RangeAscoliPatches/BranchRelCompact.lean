...
/-!
# ℤ^d branch bounded relatively compact patch wrappers

This module contains branch norm-bounded, constant norm-bounded, and
locally bounded relatively compact patch wrappers.
-/
