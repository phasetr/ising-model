...
/-!
# Per-stage complex analyticity wrappers: BranchRelCompact

Consolidated `BranchRelCompact` wrappers for the GJ §17.5.2 / §4.6
...
Compatibility module re-exporting the split branch norm-bounded relatively
compact wrapper endpoints.
-/
...
/-!
# ℤ^d branch constant norm-bounded relatively compact compact-target wrappers

This module contains the compact-target branch constant norm-bounded relatively
...
Compatibility module re-exporting the split branch constant norm-bounded
relatively compact wrapper endpoints.
-/
...
Compatibility module re-exporting the split branch locally bounded relatively
compact wrapper endpoints.
-/

/-!
# ℤ^d branch bounded relatively compact patch wrappers compatibility module

This compatibility module re-exports the branch bounded relatively compact
wrapper layer split under `PerStageComplex.RangeAscoliPatches.BranchRelCompact`.
-/
