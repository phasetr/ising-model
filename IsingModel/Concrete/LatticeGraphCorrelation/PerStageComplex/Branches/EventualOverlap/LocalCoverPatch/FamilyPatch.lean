...
/-!
# Eventual-overlap local-cover family patch wrappers

This module contains non-real local-cover family-and-patching wrappers for
structured and pointwise-normalised eventual-overlap branch data.
-/
