...
Sandwich, ratio, and downstream wrappers remain in the parent
...
PR #1936. The theorem names are the same as the former declarations in
`HighTemperatureBounds`, but callers can now import this child module
directly.
-/
