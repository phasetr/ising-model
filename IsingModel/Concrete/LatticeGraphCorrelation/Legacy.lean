...
(GJ §17.5–§17.6). Each lifts the ambient version (PR #1636)
at `G := IsingModel.latticeGraph d`. -/
...
/-! ### ℤ^d Λ-layer / along-ex joint Continuous / Differentiable
wrappers (correlation / magnetization / susceptibility) -/
...
/-! ### ℤ^d joint ContinuousAt + DifferentiableAt wrappers
(correlation / magnetization / susceptibility) -/
