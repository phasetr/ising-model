...
/-!
# ℤ^d finite-volume free-energy ferromagnetic / bot wrappers

Narrow child module for four ℤ^d Λ-induced finite-volume free-energy wrappers
extracted from `FreeEnergySpecialCasesFiniteVol.lean`:
