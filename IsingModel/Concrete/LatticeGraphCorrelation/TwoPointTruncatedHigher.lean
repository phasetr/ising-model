...
Evaluates the third truncated infinite-volume correlation on the degenerate parameter slices
and on the zero-field slice at `IsingModel.latticeGraph d`, including the coincident-site
