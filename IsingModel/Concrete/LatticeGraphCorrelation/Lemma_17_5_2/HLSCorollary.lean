...
/-!
# Substantive HLS corollary bundle

GJ-proposition-unit bundle providing corollary-named aliases denoting
derived results of the master HLS theorem.
...
/-- **Corollary: cluster property holds**. -/
theorem hls_corollary_cluster
    {d : ℕ} (hd : 1 ≤ d) {β J : ℝ}
...
/-- **Corollary: lattice mass is strictly positive**. -/
theorem hls_corollary_mass_pos
    {d : ℕ} (hd : 1 ≤ d) {β J : ℝ}
    (hf : IsingModel.Ferromagnetic (⟨J, (0 : ℝ), β⟩ : IsingParams ℝ))
    (hβJ : 0 < β * J)
    (hβJd_lt : β * J * ↑(2 * d) < 1) :
...
/-- **Corollary: exponential decay at rate `-log(βJ·2d)`**. -/
theorem hls_corollary_exp_decay
    {d : ℕ} (hd : 1 ≤ d) {β J : ℝ}
    (hf : IsingModel.Ferromagnetic (⟨J, (0 : ℝ), β⟩ : IsingParams ℝ))
    (hβJ : 0 < β * J)
    (hβJd_lt : β * J * ↑(2 * d) < 1) :
...
/-- **Corollary: susceptibility is finite**. -/
theorem hls_corollary_susc_finite
    {d : ℕ} (hd : 1 ≤ d) {β J : ℝ}
    (hf : IsingModel.Ferromagnetic (⟨J, (0 : ℝ), β⟩ : IsingParams ℝ))
    (hβJ : 0 < β * J)
    (hβJd_lt : β * J * ↑(2 * d) < 1)
...
/-- **Corollary: HLS sum bound holds**. -/
theorem hls_corollary_sum_bound
    {d : ℕ} (hd : 1 ≤ d) {β J : ℝ}
    (hf : IsingModel.Ferromagnetic (⟨J, (0 : ℝ), β⟩ : IsingParams ℝ))
    (hβJ : 0 < β * J)
    (hβJd_lt : β * J * ↑(2 * d) < 1) :
...
/-- **Corollary: all five HLS conclusions combined**. -/
theorem hls_corollary_all_conclusions
    {d : ℕ} (hd : 1 ≤ d) {β J : ℝ}
    (hf : IsingModel.Ferromagnetic (⟨J, (0 : ℝ), β⟩ : IsingParams ℝ))
    (hβJ : 0 < β * J)
    (hβJd_lt : β * J * ↑(2 * d) < 1) :
