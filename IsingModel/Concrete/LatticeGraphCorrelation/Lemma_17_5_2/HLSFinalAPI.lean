import IsingModel.Concrete.LatticeGraphCorrelation.Lemma_17_5_2.HLSSummaryStatements

/-!
# Substantive HLS final API bundle

GJ-proposition-unit bundle providing the final API closure for the
...
/-- **All-conclusions final API entry point**. -/
theorem hls_api_main
    {d : ℕ} (hd : 1 ≤ d) {β J : ℝ}
  ...
  hls_summary_all_hold hd hf hβJ hβJd_lt

/-- **Final API closure short alias**: bound. -/
theorem hls_api_bound
    {d : ℕ} (hd : 1 ≤ d) {β J : ℝ}
    (hf : IsingModel.Ferromagnetic (⟨J, (0 : ℝ), β⟩ : IsingParams ℝ))
    (hβJ : 0 < β * J)
    (hβJd_lt : β * J * ↑(2 * d) < 1) :
...
/-- **Final API closure short alias**: cluster. -/
theorem hls_api_cluster
    {d : ℕ} (hd : 1 ≤ d) {β J : ℝ}
    (hf : IsingModel.Ferromagnetic (⟨J, (0 : ℝ), β⟩ : IsingParams ℝ))
    (hβJ : 0 < β * J)
    (hβJd_lt : β * J * ↑(2 * d) < 1) :
...
/-- **Final API closure short alias**: mass. -/
theorem hls_api_mass
    {d : ℕ} (hd : 1 ≤ d) {β J : ℝ}
    (hf : IsingModel.Ferromagnetic (⟨J, (0 : ℝ), β⟩ : IsingParams ℝ))
    (hβJ : 0 < β * J)
    (hβJd_lt : β * J * ↑(2 * d) < 1) :
...
/-- **Final API closure short alias**: decay. -/
theorem hls_api_decay
    {d : ℕ} (hd : 1 ≤ d) {β J : ℝ}
    (hf : IsingModel.Ferromagnetic (⟨J, (0 : ℝ), β⟩ : IsingParams ℝ))
    (hβJ : 0 < β * J)
    (hβJd_lt : β * J * ↑(2 * d) < 1) :
