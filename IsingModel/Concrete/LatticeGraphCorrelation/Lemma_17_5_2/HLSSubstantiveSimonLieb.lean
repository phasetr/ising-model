...
This module contains the Simon-Lieb half-rate `truncated2Infinite` route to the
substantive HLS tsum bound. It is the older half-rate path kept separate from
the full-rate high-temperature summary layer.
