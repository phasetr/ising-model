...
/-!
# GJ §17.5 Lemma 17.5.2 capstone — Dini-provider finite-HLS assemblies

This module connects Dini-style derivative-profile inputs to the
larger finite-HLS assembly layer.  The Dini-order and pointwise hypotheses first
...
derivative-bound provider and Dini-order inputs**. -/
theorem lemma_17_5_2_upper_bound_of_concrete_finite_deriv_provider_of_dini_order
...
derivative-bound provider and Dini-order inputs**. -/
theorem lemma_17_5_2_sandwich_of_concrete_finite_deriv_provider_of_dini_order
    {d α : ℕ} (hα : 1 ≤ α) (hαd : 2 * α > d) (hd : 1 ≤ d)
    {Λ : Ambient.Exhaustion (Fin d → ℤ)}
    {J : ℝ} (hJ_pos : 0 < J)
    {x z : Fin d → ℤ} (hxz : x ≠ z)
...
derivative-bound provider, Dini-order inputs, and a rate comparison**. -/
theorem
    lemma_17_5_2_capstone_le_high_temp_rate_of_concrete_finite_deriv_provider_of_dini_order
    {d α : ℕ} (hα : 1 ≤ α) (hαd : 2 * α > d) (hd : 1 ≤ d)
    {Λ : Ambient.Exhaustion (Fin d → ℤ)}
    {J : ℝ} (hJ_pos : 0 < J)
    {x z : Fin d → ℤ} (hxz : x ≠ z)
...
/-- **GJ §17.5 Lemma 17.5.2 concrete capstone from a finite
derivative-bound provider, Dini-order inputs, and an endpoint profile lower
bound**. -/
theorem
    lemma_17_5_2_capstone_profile_lower_of_concrete_finite_deriv_provider_of_dini_order
    {d α : ℕ} (hα : 1 ≤ α) (hαd : 2 * α > d) (hd : 1 ≤ d)
    {Λ : Ambient.Exhaustion (Fin d → ℤ)}
    {J : ℝ} (hJ_pos : 0 < J)
    {x z : Fin d → ℤ} (hxz : x ≠ z)
...
provider and Dini-order inputs**. -/
theorem lemma_17_5_2_upper_bound_of_finite_deriv_provider_of_dini_order
    {d α : ℕ} (hα : 1 ≤ α) (hαd : 2 * α > d) (hd : 1 ≤ d)
    (Λ : Ambient.Exhaustion (Fin d → ℤ))
    {J : ℝ} (hJ_pos : 0 < J)
    {x z : Fin d → ℤ} (hxz : x ≠ z)
...
provider and Dini-order inputs**. -/
theorem lemma_17_5_2_sandwich_of_finite_deriv_provider_of_dini_order
    {d α : ℕ} (hα : 1 ≤ α) (hαd : 2 * α > d) (hd : 1 ≤ d)
    {Λ : Ambient.Exhaustion (Fin d → ℤ)}
    {J : ℝ} (hJ_pos : 0 < J)
    {x z : Fin d → ℤ} (hxz : x ≠ z)
...
and Dini-order derivative-profile inputs**: Dini-order convergence supplies
the derivative-limit provider consumed by the scalar-provider finite-HLS
assembly. -/
theorem lemma_17_5_2_upper_bound_high_temp_scalar_provider_of_dini_order
    {d α : ℕ} (hα : 1 ≤ α) (hαd : 2 * α > d) (hd : 1 ≤ d)
    (Λ : Ambient.Exhaustion (Fin d → ℤ))
    {J : ℝ} (hJ_pos : 0 < J)
    {x z : Fin d → ℤ} (hxz : x ≠ z)
...
and Dini-order derivative-profile inputs**: adds the lower validating decay input
to the Dini-order-input scalar-provider upper assembly. -/
theorem lemma_17_5_2_sandwich_high_temp_scalar_provider_of_dini_order
    {d α : ℕ} (hα : 1 ≤ α) (hαd : 2 * α > d) (hd : 1 ≤ d)
    {Λ : Ambient.Exhaustion (Fin d → ℤ)}
    {J : ℝ} (hJ_pos : 0 < J)
    {x z : Fin d → ℤ} (hxz : x ≠ z)
...
and Dini-order derivative-profile inputs**. -/
theorem lemma_17_5_2_upper_bound_of_high_temp_ratio_lower_of_dini_order
    {d α : ℕ} (hα : 1 ≤ α) (hαd : 2 * α > d) (hd : 1 ≤ d)
    (Λ : Ambient.Exhaustion (Fin d → ℤ))
    {J : ℝ} (hJ_pos : 0 < J)
    {x z : Fin d → ℤ} (hxz : x ≠ z)
    ...
    ∃ K : ℝ, 0 < K ∧
      ...
      Lemma_17_5_2_UpperBound hα hrho Λ J β₂ x z
        (ENNReal.ofReal (((2 * α + 1 : ℕ) : ℝ) * K / rho)) := by
  exact
    lemma_17_5_2_upper_bound_of_high_temp_ratio_lower_of_derivative_limit_provider
      (d := d) (α := α) (Λ := Λ) (J := J) (x := x) (z := z)
      (β₁ := β₁) (β₂ := β₂) (a := a) (b := b) (rho := rho) (h := h)
      hα hαd hd hJ_pos hxz hβ₁₂ hIcc ha hab hlt hβ_mem hrho
      hh_diff hh_nonneg hg_eq hh_pos hc_pos hm_pos
...
Dini-order derivative-profile inputs**. -/
theorem lemma_17_5_2_sandwich_of_high_temp_ratio_lower_of_dini_order
    {d α : ℕ} (hα : 1 ≤ α) (hαd : 2 * α > d) (hd : 1 ≤ d)
    {Λ : Ambient.Exhaustion (Fin d → ℤ)}
    {J : ℝ} (hJ_pos : 0 < J)
    {x z : Fin d → ℤ} (hxz : x ≠ z)
        ...
        ENNReal.ofReal (((2 * α + 1 : ℕ) : ℝ) * K / rho) *
          ENNReal.ofReal
            (pseudoMassFromParamsAtPair hα hrho d Λ
              (⟨J, 0, β₂⟩ : IsingParams ℝ) x z) := by
  exact
    lemma_17_5_2_sandwich_of_high_temp_ratio_lower_of_derivative_limit_provider
      (d := d) (α := α) (Λ := Λ) (J := J) (x := x) (z := z)
      (β₁ := β₁) (β₂ := β₂) (a := a) (b := b) (rho := rho) (h := h)
      hα hαd hd hJ_pos hxz hβ₁₂ hIcc ha hab hlt hβ_mem hrho
      hh_diff hh_nonneg hg_eq hh_pos hc_pos hm_pos
...
lower bound and Dini-order derivative-profile inputs**. -/
theorem lemma_17_5_2_upper_bound_of_high_temp_uniform_correlation_lower_of_dini_order
    {d α : ℕ} (hα : 1 ≤ α) (hαd : 2 * α > d) (hd : 1 ≤ d)
    (Λ : Ambient.Exhaustion (Fin d → ℤ))
    {J : ℝ} (hJ_pos : 0 < J)
    {x z : Fin d → ℤ} (hxz : x ≠ z)
    ...
    ∃ K : ℝ, 0 < K ∧
      ...
      Lemma_17_5_2_UpperBound hα hrho Λ J β₂ x z
        (ENNReal.ofReal (((2 * α + 1 : ℕ) : ℝ) * K / rho)) := by
  exact
    lemma_17_5_2_upper_bound_of_high_temp_uniform_correlation_lower_of_derivative_limit_provider
      (d := d) (α := α) (Λ := Λ) (J := J) (x := x) (z := z)
      (β₁ := β₁) (β₂ := β₂) (a := a) (b := b) (rho := rho) (h := h)
      hα hαd hd hJ_pos hxz hβ₁₂ hIcc ha hab hlt hβ_mem hrho
      hh_diff hh_nonneg hg_eq hh_pos hc_pos hm_pos
...
bound and Dini-order derivative-profile inputs**. -/
theorem lemma_17_5_2_sandwich_of_high_temp_uniform_correlation_lower_of_dini_order
    {d α : ℕ} (hα : 1 ≤ α) (hαd : 2 * α > d) (hd : 1 ≤ d)
    {Λ : Ambient.Exhaustion (Fin d → ℤ)}
    {J : ℝ} (hJ_pos : 0 < J)
    {x z : Fin d → ℤ} (hxz : x ≠ z)
        ...
        ENNReal.ofReal (((2 * α + 1 : ℕ) : ℝ) * K / rho) *
          ENNReal.ofReal
            (pseudoMassFromParamsAtPair hα hrho d Λ
              (⟨J, 0, β₂⟩ : IsingParams ℝ) x z) := by
  exact
    lemma_17_5_2_sandwich_of_high_temp_uniform_correlation_lower_of_derivative_limit_provider
      (d := d) (α := α) (Λ := Λ) (J := J) (x := x) (z := z)
      (β₁ := β₁) (β₂ := β₂) (a := a) (b := b) (rho := rho) (h := h)
      hα hαd hd hJ_pos hxz hβ₁₂ hIcc ha hab hlt hβ_mem hrho
      hh_diff hh_nonneg hg_eq hh_pos hc_pos hm_pos
...
infinite-correlation lower bound and Dini-order derivative-profile inputs**. -/
theorem lemma_17_5_2_upper_bound_of_uniform_correlation_lower_on_self_Icc_of_dini_order
    {d α : ℕ} (hα : 1 ≤ α) (hαd : 2 * α > d) (hd : 1 ≤ d)
    (Λ : Ambient.Exhaustion (Fin d → ℤ))
    {J : ℝ} (hJ_pos : 0 < J)
    {x z : Fin d → ℤ} (hxz : x ≠ z)
    ...
    ∃ K : ℝ, 0 < K ∧
      ...
      Lemma_17_5_2_UpperBound hα hrho Λ J β₂ x z
        (ENNReal.ofReal (((2 * α + 1 : ℕ) : ℝ) * K / rho)) := by
  exact
    lemma_17_5_2_upper_bound_of_uniform_correlation_lower_on_self_Icc_of_derivative_limit_provider
      (d := d) (α := α) (Λ := Λ) (J := J) (x := x) (z := z)
      (β₁ := β₁) (β₂ := β₂) (rho := rho) (h := h)
      hα hαd hd hJ_pos hxz hβ₁₂ hIcc hrho
      hh_diff hh_nonneg hg_eq hh_pos hc_pos hm_pos
...
infinite-correlation lower bound and Dini-order derivative-profile inputs**. -/
theorem lemma_17_5_2_sandwich_of_uniform_correlation_lower_on_self_Icc_of_dini_order
    {d α : ℕ} (hα : 1 ≤ α) (hαd : 2 * α > d) (hd : 1 ≤ d)
    {Λ : Ambient.Exhaustion (Fin d → ℤ)}
    {J : ℝ} (hJ_pos : 0 < J)
    {x z : Fin d → ℤ} (hxz : x ≠ z)
        ...
        ENNReal.ofReal (((2 * α + 1 : ℕ) : ℝ) * K / rho) *
          ENNReal.ofReal
            (pseudoMassFromParamsAtPair hα hrho d Λ
              (⟨J, 0, β₂⟩ : IsingParams ℝ) x z) := by
  exact
    lemma_17_5_2_sandwich_of_uniform_correlation_lower_on_self_Icc_of_derivative_limit_provider
      (d := d) (α := α) (Λ := Λ) (J := J) (x := x) (z := z)
      (β₁ := β₁) (β₂ := β₂) (rho := rho) (h := h)
      hα hαd hd hJ_pos hxz hβ₁₂ hIcc hrho
      hh_diff hh_nonneg hg_eq hh_pos hc_pos hm_pos
...
Dini-order derivative-profile inputs**: returns the named upper-bound predicate
and sandwich for the same HLS constant. -/
theorem
    lemma_17_5_2_capstone_of_high_temp_uniform_correlation_lower_of_dini_order
    {d α : ℕ} (hα : 1 ≤ α) (hαd : 2 * α > d) (hd : 1 ≤ d)
    {Λ : Ambient.Exhaustion (Fin d → ℤ)}
    {J : ℝ} (hJ_pos : 0 < J)
    {x z : Fin d → ℤ} (hxz : x ≠ z)
        ...
        ENNReal.ofReal (((2 * α + 1 : ℕ) : ℝ) * K / rho) *
          ENNReal.ofReal
            (pseudoMassFromParamsAtPair hα hrho d Λ
              (⟨J, 0, β₂⟩ : IsingParams ℝ) x z) := by
  exact
    lemma_17_5_2_capstone_of_high_temp_uniform_correlation_lower_of_deriv_provider
      (d := d) (α := α) (Λ := Λ) (J := J) (x := x) (z := z)
      (β₁ := β₁) (β₂ := β₂) (a := a) (b := b) (rho := rho) (h := h)
      hα hαd hd hJ_pos hxz hβ₁₂ hIcc ha hab hlt hβ_mem hrho
      hh_diff hh_nonneg hg_eq hh_pos hc_pos hm_pos
...
capstone from Dini-order derivative-profile inputs**. -/
theorem lemma_17_5_2_capstone_of_uniform_correlation_lower_self_Icc_of_dini_order
    {d α : ℕ} (hα : 1 ≤ α) (hαd : 2 * α > d) (hd : 1 ≤ d)
    {Λ : Ambient.Exhaustion (Fin d → ℤ)}
    {J : ℝ} (hJ_pos : 0 < J)
    {x z : Fin d → ℤ} (hxz : x ≠ z)
        ...
        ENNReal.ofReal (((2 * α + 1 : ℕ) : ℝ) * K / rho) *
          ENNReal.ofReal
            (pseudoMassFromParamsAtPair hα hrho d Λ
              (⟨J, 0, β₂⟩ : IsingParams ℝ) x z) := by
  exact
    lemma_17_5_2_capstone_of_uniform_correlation_lower_self_Icc_of_deriv_provider
      (d := d) (α := α) (Λ := Λ) (J := J) (x := x) (z := z)
      (β₁ := β₁) (β₂ := β₂) (rho := rho) (h := h)
...
/-- **GJ §17.5 Lemma 17.5.2 upper bound from compact ratio bounds and Dini-order
derivative-profile inputs**. -/
theorem lemma_17_5_2_upper_bound_of_high_temp_compact_ratio_bounds_of_dini_order
    {d α : ℕ} (hα : 1 ≤ α) (hαd : 2 * α > d) (hd : 1 ≤ d)
    (Λ : Ambient.Exhaustion (Fin d → ℤ))
    {J : ℝ} (hJ_pos : 0 < J)
    {x z : Fin d → ℤ} (hxz : x ≠ z)
...
/-- **GJ §17.5 Lemma 17.5.2 sandwich from compact ratio bounds and Dini-order
derivative-profile inputs**. -/
theorem lemma_17_5_2_sandwich_of_high_temp_compact_ratio_bounds_of_dini_order
    {d α : ℕ} (hα : 1 ≤ α) (hαd : 2 * α > d) (hd : 1 ≤ d)
    {Λ : Ambient.Exhaustion (Fin d → ℤ)}
    {J : ℝ} (hJ_pos : 0 < J)
    {x z : Fin d → ℤ} (hxz : x ≠ z)
...
/-- **GJ §17.5 Lemma 17.5.2 compact-ratio finite-HLS capstone from Dini-order
derivative-profile inputs**: returns the named upper-bound predicate and
sandwich for the same HLS constant. -/
theorem lemma_17_5_2_capstone_of_high_temp_compact_ratio_bounds_of_dini_order
    {d α : ℕ} (hα : 1 ≤ α) (hαd : 2 * α > d) (hd : 1 ≤ d)
    {Λ : Ambient.Exhaustion (Fin d → ℤ)}
    {J : ℝ} (hJ_pos : 0 < J)
    {x z : Fin d → ℤ} (hxz : x ≠ z)
        ...
        ENNReal.ofReal (((2 * α + 1 : ℕ) : ℝ) * K / rho) *
          ENNReal.ofReal
            (pseudoMassFromParamsAtPair hα hrho d Λ
              (⟨J, 0, β₂⟩ : IsingParams ℝ) x z) := by
  exact
    lemma_17_5_2_capstone_of_high_temp_compact_ratio_bounds_of_deriv_provider
      (d := d) (α := α) (Λ := Λ) (J := J) (x := x) (z := z)
      (β₁ := β₁) (β₂ := β₂) (a := a) (b := b) (rho := rho) (h := h)
      hα hαd hd hJ_pos hxz hβ₁₂ hIcc ha hab hlt hβ_mem hrho
      hh_diff hh_cont hh_nonneg hg_eq hh_pos hc_pos hm_pos
...
from Dini-order derivative-profile inputs**. -/
theorem lemma_17_5_2_capstone_of_compact_ratio_bounds_self_Icc_of_dini_order
    {d α : ℕ} (hα : 1 ≤ α) (hαd : 2 * α > d) (hd : 1 ≤ d)
    {Λ : Ambient.Exhaustion (Fin d → ℤ)}
    {J : ℝ} (hJ_pos : 0 < J)
    {x z : Fin d → ℤ} (hxz : x ≠ z)
        ...
        ENNReal.ofReal (((2 * α + 1 : ℕ) : ℝ) * K / rho) *
          ENNReal.ofReal
            (pseudoMassFromParamsAtPair hα hrho d Λ
              (⟨J, 0, β₂⟩ : IsingParams ℝ) x z) := by
  exact
    lemma_17_5_2_capstone_of_compact_ratio_bounds_self_Icc_of_deriv_provider
      (d := d) (α := α) (Λ := Λ) (J := J) (x := x) (z := z)
      (β₁ := β₁) (β₂ := β₂) (rho := rho) (h := h)
      hα hαd hd hJ_pos hxz hβ₁₂ hIcc hrho hh_diff hh_cont hh_nonneg
      hg_eq hh_pos hc_pos hm_pos
