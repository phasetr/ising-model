...
/-!
# Substantive HLS presents aliases bundle

GJ-proposition-unit bundle providing `presents_*` style aliases.
...
/-! ## Presents-style aliases -/

/-- **Presents: HLS cluster**. -/
theorem presents_hls_cluster
    {d : ℕ} (hd : 1 ≤ d) {β J : ℝ}
...
/-- **Presents: HLS mass positive**. -/
theorem presents_hls_mass_positive
    {d : ℕ} (hd : 1 ≤ d) {β J : ℝ}
    (hf : IsingModel.Ferromagnetic (⟨J, (0 : ℝ), β⟩ : IsingParams ℝ))
    (hβJ : 0 < β * J)
    (hβJd_lt : β * J * ↑(2 * d) < 1) :
