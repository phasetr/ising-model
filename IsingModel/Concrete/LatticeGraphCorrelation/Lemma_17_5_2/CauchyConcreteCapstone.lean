...
/-!
# GJ §17.5 Lemma 17.5.2 capstone — Cauchy-provider concrete capstones
...
/-- **GJ §17.5 Lemma 17.5.2 automatic active-range upper bound from named
Cauchy inputs**: compact-interval metric Cauchy control supplies the
derivative-limit provider required by the concrete compact-ratio upper-bound
wrapper. -/
theorem lemma_17_5_2_upper_bound_compact_auto_active_of_cauchy
...
theorem lemma_17_5_2_upper_bound_compact_self_Icc_auto_active_of_cauchy
    {d α : ℕ} (hα : 1 ≤ α) (hαd : 2 * α > d) (hd : 1 ≤ d)
    (Λ : Ambient.Exhaustion (Fin d → ℤ))
    {J : ℝ} (hJ_pos : 0 < J)
    {x z : Fin d → ℤ} (hxz : x ≠ z)
...
Cauchy inputs**. -/
theorem lemma_17_5_2_sandwich_le_high_temp_rate_on_Icc_of_cauchy
    {d α : ℕ} (hα : 1 ≤ α) (hαd : 2 * α > d) (hd : 1 ≤ d)
    {Λ : Ambient.Exhaustion (Fin d → ℤ)}
    {J : ℝ} (hJ_pos : 0 < J)
    {x z : Fin d → ℤ} (hxz : x ≠ z)
...
named Cauchy inputs**. -/
theorem lemma_17_5_2_sandwich_le_high_temp_rate_on_self_Icc_of_cauchy
    {d α : ℕ} (hα : 1 ≤ α) (hαd : 2 * α > d) (hd : 1 ≤ d)
    {Λ : Ambient.Exhaustion (Fin d → ℤ)}
    {J : ℝ} (hJ_pos : 0 < J)
    {x z : Fin d → ℤ} (hxz : x ≠ z)
...
bound and named Cauchy inputs**. -/
theorem lemma_17_5_2_sandwich_profile_lower_on_Icc_of_cauchy
    {d α : ℕ} (hα : 1 ≤ α) (hαd : 2 * α > d) (hd : 1 ≤ d)
    {Λ : Ambient.Exhaustion (Fin d → ℤ)}
    {J : ℝ} (hJ_pos : 0 < J)
    {x z : Fin d → ℤ} (hxz : x ≠ z)
...
lower bound and named Cauchy inputs**. -/
theorem lemma_17_5_2_sandwich_profile_lower_on_self_Icc_of_cauchy
    {d α : ℕ} (hα : 1 ≤ α) (hαd : 2 * α > d) (hd : 1 ≤ d)
    {Λ : Ambient.Exhaustion (Fin d → ℤ)}
    {J : ℝ} (hJ_pos : 0 < J)
    {x z : Fin d → ℤ} (hxz : x ≠ z)
...
Cauchy inputs**. -/
theorem lemma_17_5_2_capstone_le_high_temp_rate_on_Icc_of_cauchy
    {d α : ℕ} (hα : 1 ≤ α) (hαd : 2 * α > d) (hd : 1 ≤ d)
    {Λ : Ambient.Exhaustion (Fin d → ℤ)}
    {J : ℝ} (hJ_pos : 0 < J)
    {x z : Fin d → ℤ} (hxz : x ≠ z)
...
named Cauchy inputs**. -/
theorem lemma_17_5_2_capstone_le_high_temp_rate_on_self_Icc_of_cauchy
    {d α : ℕ} (hα : 1 ≤ α) (hαd : 2 * α > d) (hd : 1 ≤ d)
    {Λ : Ambient.Exhaustion (Fin d → ℤ)}
    {J : ℝ} (hJ_pos : 0 < J)
    {x z : Fin d → ℤ} (hxz : x ≠ z)
...
bound and named Cauchy inputs**. -/
theorem lemma_17_5_2_capstone_profile_lower_on_Icc_of_cauchy
    {d α : ℕ} (hα : 1 ≤ α) (hαd : 2 * α > d) (hd : 1 ≤ d)
    {Λ : Ambient.Exhaustion (Fin d → ℤ)}
    {J : ℝ} (hJ_pos : 0 < J)
    {x z : Fin d → ℤ} (hxz : x ≠ z)
...
lower bound and named Cauchy inputs**. -/
theorem lemma_17_5_2_capstone_profile_lower_on_self_Icc_of_cauchy
    {d α : ℕ} (hα : 1 ≤ α) (hαd : 2 * α > d) (hd : 1 ≤ d)
    {Λ : Ambient.Exhaustion (Fin d → ℤ)}
    {J : ℝ} (hJ_pos : 0 < J)
    {x z : Fin d → ℤ} (hxz : x ≠ z)
