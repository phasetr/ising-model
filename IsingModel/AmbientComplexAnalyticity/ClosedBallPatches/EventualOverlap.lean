import IsingModel.AmbientComplexAnalyticity.ClosedBallPatches.ViaLocal

/-!
# Closed-ball patches split — eventual-overlap closed-ball branch-local direct-range patches
