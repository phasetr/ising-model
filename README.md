...
| Truncated 2-point bound (§5.1) | `0 ≤ ⟨σ_i;σ_j⟩ ≤ 1` for ferromagnetic | Glimm-Jaffe §5.1 |
| Mixed-phase formula (§5.1) | `M² - (M(2α-1))² = 4α(1-α)M²` | Glimm-Jaffe §5.1 |
| Mixed-phase pure iff (§5.1) | `4α(1-α)M² = 0 ↔ α = 0 ∨ α = 1` | Glimm-Jaffe §5.1 |
