...
rather than the full lower-bound side of the lemma, but it replaces the direct
infinite-volume correlation hypothesis by an explicit tanh-power comparison.
