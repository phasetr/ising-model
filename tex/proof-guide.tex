...
\texttt{correlationAlongExhaustion\_cubic\_succ\_sub\_le\_poly\_pow}
(\texttt{CubicShellDecaySum.lean}); composes with existing
\texttt{lemma\_17\_5\_2\_\{upper\_bound,capstone\}\_of\_poly\_geometric\_increments\_on\_covered\_stages}
(\texttt{IncrementCapstone.lean} via \texttt{summable\_cubicBox\_boundary\_card\_mul\_geometric}).
