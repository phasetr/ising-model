...
(ball-boundary) Simon--Lieb argument applied to cubic shells, which is the
remaining Phase-3a work.  Its geometric foundation is in place: a vertex lying in the stage-\(n+1\) cube but not the
