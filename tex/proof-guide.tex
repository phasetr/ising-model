...
infinite-HLS bridge interface.  Fourteen entry points feed
...
package, a high-temperature ratio-lower package that returns both the concrete
interval infinite-HLS denominator comparisons and endpoint path-rate comparison
for one enlarged HLS constant, concrete infinite-HLS/path-rate upper-bound and
sandwich packages, the finite-HLS-to-infinite Lipschitz package, and the
enlarged upper/sandwich packages.  This keeps the bridge layer aligned with
