...
\texttt{Ambient.inducedGraph (latticeGraph d)\,$\Lambda$} subgraph,
giving the GJ~\S4.2 Prop.~4.2.1 slice and the monotone-bounded
convergence of $J$, $h$, $\beta$ along $\mathbb{N}$ on any
finite $\Lambda \subset \mathbb{Z}^d$.
