...
\end{Verbatim}
with the constant/local bounded wrappers still in
\begin{Verbatim}[fontsize=\footnotesize]
RangeAscoliPatches/BranchRelCompact/ConstNormBounded.lean
RangeAscoliPatches/BranchRelCompact/LocallyBounded.lean
\end{Verbatim}
The norm-bounded wrappers are re-exported by
\texttt{BranchRelCompact/NormBounded.lean}, and the full layer remains
re-exported by the \texttt{BranchRelCompact.lean} umbrella path.
