...
\texttt{HighTemperatureBounds}. The legacy import path is preserved.
...
pair-correlation exponential-decay capstones (8 theorems:
$\mathrm{correlation}\Lambda\_\mathrm{latticeGraph}$ and
$\mathrm{correlationAlongExhaustion}\_\mathrm{latticeGraph}$ versions of
\texttt{tanh\_pow\_dist} / \texttt{exp\_rate\_dist} /
\texttt{exp\_alpha\_dist} /
\texttt{exp\_alpha\_dist\_of\_le\_highTempExpRate} plus ferromagnetic
variants) out of \texttt{HighTemperatureBounds.lean} into a new child
