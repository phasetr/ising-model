...
infinite-HLS bridge interface.  Twenty-four entry points feed
...
upper/sandwich wrappers, compact-ratio-bounds provider upper/sandwich wrappers
and their self-interval variants, concrete infinite-HLS/path-rate upper-bound
...
\texttt{DerivativeLimitProviderCauchyHLS.lean} packages thirteen entry points
that
...
concrete compact-ratio upper/sandwich wrappers and their self-interval
variants, concrete path-rate upper/sandwich packages,
...
\texttt{DerivativeLimitProviderDiniHLS.lean} packages thirteen entry points
that
...
infinite-Lipschitz packages, concrete compact-ratio upper/sandwich wrappers
and their self-interval variants, concrete path-rate upper/sandwich packages,
