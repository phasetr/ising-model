...
This is a compact-uniform bound for the partition functions themselves.  It
is one boundedness input for the future normal-family/Montel construction of
coherent locally uniformly convergent logarithmic branches; it does not yet
prove that construction.
Reference: Glimm--Jaffe \cite{glimm-jaffe}, \S 4.6, pp.~67--70.
\end{theorem}
