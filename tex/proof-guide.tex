...
infinite-HLS bridge interface.  Thirteen entry points feed
...
package, concrete infinite-HLS/path-rate upper-bound and sandwich packages,
the finite-HLS-to-infinite Lipschitz package, and the enlarged upper/sandwich
packages.  This keeps the bridge layer aligned with the provider-shaped
capstone API: callers moving from finite derivative bounds, the infinite HLS
denominator comparison, or the path-rate all-rate bridge into the infinite-HLS
pipeline no longer need to name the limiting derivative profile \(g'\).
