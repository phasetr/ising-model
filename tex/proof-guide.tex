...
The concrete \(\mathbb Z^d\) wrappers are
\begin{Verbatim}
freeEnergyComplexAlongExhaustion_allStageData_finRealCover_patch_latticeGraph
freeEnergyComplexAlongExhaustion_allStageData_compactRealCover_patch_latticeGraph
\end{Verbatim}
in \texttt{Concrete/LatticeGraphCorrelation/PerStageComplex.lean}.
