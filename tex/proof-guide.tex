...
vanishes on any nonempty $A$. Hence
$\langle\sigma_i\sigma_j\rangle = 0$ and
$\langle\sigma_i\rangle = \langle\sigma_j\rangle = 0$, so the
truncated value is $0 - 0 \cdot 0 = 0$.
Note that unlike the $J = 0$ slice, here no $i \neq j$ hypothesis
is required. Reference: Glimm--Jaffe \cite{glimm-jaffe} \S 5.1,
pp.~72--74 (cluster property context).
\end{proof}
