...
\texttt{DerivativeLimitProviderCauchyHLS.lean} packages nine entry points that
...
concrete path-rate upper/sandwich packages, finite-HLS-to-infinite Lipschitz
package, path-rate enlarged package, and the enlarged upper/sandwich
assemblies.  Thus a future concrete Cauchy estimate for the beta-derivative
profiles can be consumed by the HLS-uniform capstone path without separately
naming the intermediate provider witness.

The Dini criteria are wired to the same infinite-HLS bridge layer.
\texttt{DerivativeLimitProviderDiniHLS.lean} packages nine entry points that
...
infinite-Lipschitz packages, concrete path-rate upper/sandwich packages,
