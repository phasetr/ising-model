...
self-implementation required), followed by
\texttt{vitali\_bridge\_leeYangDomain} application, and a global
branch patched from the local pieces via simple connectivity.
