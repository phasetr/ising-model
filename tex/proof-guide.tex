...
This narrows the remaining Montel input to pointwise compactness and
equicontinuity of the selected branch restrictions, plus coherent overlap
equality.  It still does not derive those inputs from holomorphy and local
boundedness.
Reference: Glimm--Jaffe \cite{glimm-jaffe}, \S 4.6, pp.~67--70.
\end{theorem}
