...
pair-correlation exponential-decay capstones (16 theorems total: four
capstone families
\texttt{tanh\_pow\_dist} / \texttt{exp\_rate\_dist} /
\texttt{exp\_alpha\_dist} /
\texttt{exp\_alpha\_dist\_of\_le\_highTempExpRate}, each in
$\mathrm{correlation}\Lambda\_\mathrm{latticeGraph}$ and
$\mathrm{correlationAlongExhaustion}\_\mathrm{latticeGraph}$ versions plus
ferromagnetic variants of both) out of
