...
\begin{remark}[Status of PR \#200 — 2026-04-20]
PR \#200 is \emph{deferred} at draft state on branch
\texttt{feat/thm-4-6-2-slitPlane-on-leeYangDomain} (137 commits, clean
build, no sorry). Completed in this PR: Morera-based pointwise local
analytic log-$Z$ branch on the Lee-Yang domain (headline
...
Remaining: Montel-style locally uniform convergence of $f_\Lambda$ on
Lee-Yang (mathlib lacks Montel; self-implementation required),
followed by \texttt{vitali\_bridge\_leeYangDomain} application, and a
global branch patched from the local pieces via simple connectivity.
