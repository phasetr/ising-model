...
\textit{Reference}: Glimm--Jaffe \S17.5, formula~(17.5.5), p.~428 (2nd~ed.).

\subsubsection*{Full Lemma 17.5.2 and Theorem 17.5.1}

Using Steps 117a--g combined with the HLS axiom, the goals are:

\begin{theorem}[Lemma 17.5.2]
For all $\beta$:
\[
...
\begin{theorem}[Theorem 17.5.1]
The lattice mass function $m(\beta)$ is continuous at $\beta = \beta_c$.
\end{theorem}

\noindent\textit{Status}: In progress (PR~\#929).
File: \texttt{PseudoMass.lean}.
References: Glimm--Jaffe \S17.5~pp.~310--312~(2nd~ed.).
