...
Issue \#2965 Phase C, real-axis route)]
For an exhaustion $\Lambda$ of $\mathbb{Z}^d = \mathrm{Fin}\,d\to\mathbb{Z}$, sites
$r\ne s\in\Lambda.\mathrm{volume}\,n$, $J\ge 0$ and $\beta>0$, there exists
