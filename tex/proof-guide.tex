...
infinite-HLS bridge interface.  Ten entry points feed
...
infinite-Lipschitz package, the finite-HLS-to-infinite Lipschitz package, and
the enlarged upper/sandwich packages.  This keeps the bridge layer aligned
with the provider-shaped capstone API: callers moving from finite derivative
bounds or the infinite HLS denominator comparison into the infinite-HLS
...
\texttt{DerivativeLimitProviderCauchyHLS.lean} packages six entry points that
...
the HLS-denominator-comparison to infinite-Lipschitz package,
...
\texttt{DerivativeLimitProviderDiniHLS.lean} packages six entry points that
...
infinite-Lipschitz package, finite-HLS-to-infinite Lipschitz package,
