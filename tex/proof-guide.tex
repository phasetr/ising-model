...
mass in the strict high-temperature regime. This discharges the
exhaustion-uniform high-temperature decay transfer used by the
Step~117l bridge. The remaining pseudo-mass-specific input is to
identify the concrete pair pseudo-mass itself as a validating rate, or
to compare it quantitatively with the transferred Simon--Lieb rate.
