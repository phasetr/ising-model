...
This is only the two-ball base case for diagonal extraction.  It does not prove
Montel compactness, arbitrary finite-cover extraction, compatibility of the two
limits on overlaps, or global patching on \(\texttt{leeYangDomain}\).
Reference: Glimm--Jaffe \cite{glimm-jaffe}, \S 4.6, pp.~67--70.
\end{theorem}
