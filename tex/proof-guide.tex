...
PR~\#1828 packages the downstream cluster and summability consequences.  The
named summand
...
PR~\#1829 packages the corresponding explicit product-sum upper bounds.  Once
the named rate \(m\) supplies a positive exponential-decay witness, Step~127
...
the $\Lambda$-layer wrapper remains in
\texttt{IsingModel/AmbientLattice/Analyticity.lean}
(moved from the legacy modules in PR~\#1863).
...
and
\texttt{Concrete/LatticeGraphCorrelation/VdPolymerFamiliesAnalyticity.lean};
the $\Lambda$-layer wrappers remain in
\texttt{IsingModel/AmbientLattice/Analyticity.lean}
(moved from the legacy modules in PR~\#1863).
...
\texttt{AmbientLattice/SpecialCases.lean}, and
\texttt{Concrete/LatticeGraphCorrelation.lean}. The along-exhaustion
and concrete \texttt{AnalyticAt} wrappers from this family now live in
\texttt{AmbientLattice/SpecialCases/VdPolymerFamiliesAnalyticity.lean}
and
\texttt{Concrete/LatticeGraphCorrelation/VdPolymerFamiliesAnalyticity.lean};
the $\Lambda$-layer wrappers remain in
...
\texttt{IsingModel/AmbientLattice/Analyticity.lean},
\texttt{AmbientLattice/SpecialCases/HighTemperature.lean}, and
\texttt{Concrete/LatticeGraphCorrelation/HighTemperature.lean}. Each is a thin
direct-instantiation wrapper of the abstract theorem on the
corresponding induced subgraph. These high-temperature sandwich wrappers
now live in the dedicated child modules rather than the legacy monoliths
(moved in PR~\#1864).
...
\begin{itemize}
  ...
  \item \emph{$\mathbb{Z}^d$ concrete wraps}: 8 theorems in
    \texttt{Concrete/LatticeGraphCorrelation/HighTemperature.lean}, covering both
...
in \texttt{AmbientLattice/SpecialCases/HighTemperatureBounds.lean}, plus the
