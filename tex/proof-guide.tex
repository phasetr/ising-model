...
\]
and subtracting at the endpoints $s=0$ (bond-deleted) and $s=1$ (full) gives the
coupling difference
\[
...
covariance differences, whose bulk contributions (edges far from the cut shell) cancel
between $s=0$ and $s=1$, leaving a shell-localized contribution.
\end{theorem}
