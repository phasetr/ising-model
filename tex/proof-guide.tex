...
\texttt{correlationAlongExhaustion\_tendstoUniformlyOn\_beta}.  The direct
assemblies
...
feed this \(L\) into the high-temperature ratio-lower package above.  Thus the
finite ratio-lower premise has been reduced to interval positivity and upper
bounds for the infinite correlation and the pseudo-mass denominator.
