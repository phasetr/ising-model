...
formalized.  Applying the one-step bound with the universal \(\le 1\) bound gives
the first quantitative decay step \(\langle\sigma_i\sigma_j\rangle^\infty\le\beta J\,2d\)
for every non-adjacent pair
...
\(\beta J\,2d<1\).  Its geometric foundation is in place: a vertex lying in the stage-\(n+1\) cube but not the
