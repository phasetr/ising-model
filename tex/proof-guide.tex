...
combine this scalar comparison with the finite-HLS Lipschitz package, so the
remaining high-temperature HLS upper side is reduced to the finite derivative
inputs plus this explicit path-rate-to-HLS comparison.
