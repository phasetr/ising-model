...
(\texttt{correlationInfinite\_latticeGraph\_le\_of\_neighbors\_le}); iterating
over the lattice distance yields \((\beta J\,2d)^{\mathrm{dist}}\) without the
volume-dependent prefactor of the naive finite-volume bound.  Its geometric
foundation is in place: a vertex lying in the stage-\(n+1\) cube but not the
