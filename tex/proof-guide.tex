...
\((0,(J\,2d)^{-1})\) to some limiting derivative profile.  The extraction
lemmas
...
uniform Cauchy, and epsilon--\(N\) metric-Cauchy consequences.  Its entry-point
package also contains ten wrappers, all with suffix
...
sandwich, capstone, and compact-Cauchy callers no longer need to name the
limiting derivative function \(g'\) directly; the substantive analytic work is
proving the provider itself in the desired high-temperature regime.
