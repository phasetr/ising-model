...
the returned HLS constant.  The finite-stage versions
...
then specialize this package to the finite-HLS route, so the remaining
high-temperature HLS upper side is reduced to the finite derivative inputs plus
this explicit path-rate-to-HLS comparison.
