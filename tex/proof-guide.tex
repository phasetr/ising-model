...
normalisation in the same witness.  If
...
apply this theorem to the induced graph on $\Lambda_n$.  Thus, at every
nonempty stage, the same local witness carries analyticity on the ball,
