...
\]
This is the explicit per-stage $\beta$-derivative increment $F_{k+1}(\beta)-F_k(\beta)$;
its bound, via the shell cancellation of the full-energy $\langle\sigma^A H\rangle$
terms between the two systems, is the remaining quantitative input of the capstone.
\end{proposition}
