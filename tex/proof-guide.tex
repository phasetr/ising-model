...
infinite-HLS bridge interface.  Nine entry points feed
...
comparisons from finite derivative bounds, the finite-HLS-to-infinite Lipschitz
package, and the enlarged upper/sandwich packages.  This keeps the bridge layer
aligned with the provider-shaped capstone API: callers moving from finite
derivative bounds into the infinite-HLS pipeline no longer need to name the
limiting derivative profile \(g'\).
