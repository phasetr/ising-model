...
The bottom-graph (`⊥ ≤ latticeGraph d`) comparison wrappers and the
matching `*_latticeGraph_monotone_ambient_subgraph` family now live in
\path{IsingModel/Concrete/LatticeGraphCorrelation/TwoPointAmbientBot.lean}
(narrowed out of \path{TwoPoint.lean} in PR~\#2009).
