...
membership:
\path{cubicNamedRate_ofReal_mem_Icc_latticeMass_of_le_high_temp_rate} and
\path{cubicNamedRate_ofReal_mem_Icc_latticeMass_of_cubic_pseudoMassG_le_corr}
give
\[
...
\]
while
\path{cubicNamedRate_ofReal_mem_Ioc_latticeMass_of_pos_le_high_temp_rate},
\path{cubicNamedRate_ofReal_mem_Ioc_latticeMass_of_cubic_pseudoMassG_le_corr},
and
\path{cubicNamedRate_ofReal_mem_Ioc_latticeMass_of_corr_mem_le_high_temp_rate}
give the sharpened
\(\operatorname{ofReal}(m^-_{\mathrm{cub}}) \in
