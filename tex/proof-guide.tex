...
\emph{diverges} with the shell size and so cannot prove convergence of $c_k$. The
entire increment chain is therefore re-derived with the \emph{tight} ball-boundary
