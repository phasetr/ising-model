...
(\texttt{latticeDistance\_ge\_of\_mem\_cubicBox\_succ\_not\_mem}).  Fresh
exhaustion vertices thus recede from any fixed pair at unit speed in the
exhaustion stage, which is the boundary-distance growth driving the (still to be
formalized) exponential decay of the increment contributions.
