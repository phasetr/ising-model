...
\texttt{HighTemperatureBoundsRatioBounds} in PR~\#1937; the
alongExhaustion correlation/sandwich basic wrappers were further split
out into \texttt{HighTemperatureBoundsAlongExhaustionBasic} in
PR~\#1938.
...
$\mathrm{triple\_ratio\_*}$ wrappers (29 theorems for
$\mathrm{partitionFunctionAlongExhaustion}\_\mathrm{latticeGraph}$,
$\mathrm{freeEnergyAlongExhaustion}\_\mathrm{latticeGraph}$, and
$\mathrm{log}\_\mathrm{partitionFunctionAlongExhaustion}\_\mathrm{latticeGraph}$
with bundle / triple\_* / \texttt{\_of\_nonempty} variants plus
ferromagnetic counterparts) out of \texttt{HighTemperatureBounds.lean}
into a new child
\texttt{Concrete/LatticeGraphCorrelation/HighTemperatureBoundsAlongExhaustionRatioBounds.lean}.
The legacy import path is preserved.
