...
\texttt{DerivativeLimitProviderCauchyHLS.lean} packages five entry points that
...
enlarged upper/sandwich assemblies.  Thus a future concrete Cauchy estimate for
the beta-derivative profiles can be consumed by the HLS-uniform capstone path
without separately naming the intermediate provider witness.

The Dini criteria are wired to the same infinite-HLS bridge layer.
\texttt{DerivativeLimitProviderDiniHLS.lean} packages five entry points that
...
interval infinite-HLS comparison, finite-HLS-to-infinite Lipschitz package,
path-rate enlarged package, and enlarged upper/sandwich assemblies.  This makes
the Dini route directly consumable by the HLS-uniform capstone path while
