...
infinite-HLS bridge interface.  Seventeen entry points feed
...
enlarged HLS constant, a ratio-lower-to-upper-bound wrapper, concrete
infinite-HLS/path-rate upper-bound and sandwich packages, the
