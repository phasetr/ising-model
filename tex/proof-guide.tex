...
\begin{theorem}[\texttt{susceptibilityΛ\_le\_of\_high\_temp}; GJ~\S5.1 / FV~\S3.7.3]
  ...
  $\chi_\Lambda(i) = \sum_{j\in\Lambda}\langle\sigma_i\sigma_j\rangle_\Lambda \le \beta J D/(1-\beta J D)$.
\end{theorem}
\begin{proof}
  By \texttt{truncated2\_h\_zero}: $U_2(i,j)=\langle\sigma_i\sigma_j\rangle$ at $h=0$.
  By \texttt{magnetization\_zero\_at\_h\_zero}: diagonal term $\langle\sigma_i\sigma_i\rangle=0$.
