...
\end{Verbatim}
and the concrete \(\mathbb Z^d\) wrappers live in
\texttt{Concrete/LatticeGraphCorrelation/PerStageComplex.lean} with the
corresponding \texttt{\_latticeGraph} names.
