...
Ten entry points feed \texttt{Lemma\_17\_5\_2\_DerivativeLimitProvider} into
the direct finite-derivative-provider, scalar-provider, ratio-lower,
...
direct finite-derivative-provider, scalar-provider, ratio-lower,
...
\texttt{DiniFiniteHLS.lean} then feeds that provider into the direct
