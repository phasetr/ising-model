...
\texttt{SimpleGraph.innerVertexBoundary G S} and Cheeger-type
bound (PR~\#786).}
...
this becomes the linear vertex-isoperimetric inequality
...
$\mathrm{latticeGraph\_degree\_le}$. As with PR~\#785, this PR is
preparatory infrastructure: no Simon--Lieb result is established
here.
