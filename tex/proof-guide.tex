...
infinite-HLS bridge interface.  Twenty-six entry points feed
...
upper/sandwich wrappers, compact-ratio-bounds provider
...
\texttt{DerivativeLimitProviderCauchyHLS.lean} packages fifteen entry points
that
...
concrete compact-ratio upper/sandwich/capstone wrappers and their
...
\texttt{DerivativeLimitProviderDiniHLS.lean} packages fifteen entry points
that
...
infinite-Lipschitz packages, concrete compact-ratio upper/sandwich/capstone
