...
\begin{theorem}[GJ \S 4.6 Prop 4.6.1, concrete translation-invariant lattice;
PR \#244]
...
programme. Constructing a compatible
\texttt{TranslationInvariantExhaustion} on $\mathbb{Z}^d$ requires
either relaxing the single-block \texttt{volume\_succ} assumption
or weakening the two-sided \texttt{Exhaustion.exhaust} requirement;
this structural refactor is deferred to a subsequent PR.
Reference: Glimm--Jaffe \cite{glimm-jaffe} \S 4.6 Prop 4.6.1, p.~64.
