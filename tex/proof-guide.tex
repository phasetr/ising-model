...
component-factorization capstone below. Paired with the ball-boundary increment
\texttt{correlation\_sub\_deleteEdges\_le\_derivBound} it gives the per-stage
exhaustion increment bound.
\end{theorem}
