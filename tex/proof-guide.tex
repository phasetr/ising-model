...
\subsection{The full $+$-state functional
...
$+$-state functional and its linearity, normalisation, and positivity
(FV~Theorem~3.17).  A \texttt{LocalObservable}~$d$ is an arbitrary real function
...
finite-volume algebra: the functional is linear
