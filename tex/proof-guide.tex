...
\(C\le c_\infty(\beta)\) with \(C>0\), and
...
finite ratio-lower premise has been reduced to two interval bounds on the
infinite correlation and the pseudo-mass denominator.
