...
PR~\#1932 further splits the concrete partition-function and free-energy
high-temperature expansion / sandwich / bound wrappers
($\mathrm{partitionFunction}\Lambda\_\mathrm{latticeGraph}\_\mathrm{high}\_\mathrm{temp}\_\mathrm{expansion}$ family,
$\mathrm{freeEnergy}\Lambda\_\mathrm{latticeGraph}\_\mathrm{high}\_\mathrm{temp}\_*$ family, and
related along-exhaustion / log-partition / correlation-empty wrappers) out of
