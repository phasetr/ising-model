...
infinite-HLS bridge interface.  Twenty-eight entry points feed
...
upper/sandwich wrappers and their self-interval variants,
...
\texttt{DerivativeLimitProviderCauchyHLS.lean} packages seventeen entry points
that
...
concrete uniform-correlation-lower upper/sandwich wrappers on the self
interval, concrete compact-ratio upper/sandwich/capstone wrappers and their
self-interval variants, concrete path-rate upper/sandwich packages,
...
\texttt{DerivativeLimitProviderDiniHLS.lean} packages seventeen entry points
that
...
infinite-Lipschitz packages, concrete uniform-correlation-lower upper/sandwich
wrappers on the self interval, concrete compact-ratio upper/sandwich/capstone
wrappers and their self-interval variants, concrete path-rate upper/sandwich
packages,
...
Twenty entry points feed \texttt{Lemma\_17\_5\_2\_DerivativeLimitProvider}
...
uniform-correlation-lower and self-interval uniform-correlation-lower,
