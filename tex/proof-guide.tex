...
\texttt{CauchyFiniteHLS.lean} names the compact-interval metric Cauchy
hypothesis and the pointwise derivative-profile limit hypothesis, proves the
corresponding provider helper, and feeds that provider into the scalar-provider,
ratio-lower, uniform-correlation-lower, and compact-ratio-bounds
upper/sandwich assemblies.  This keeps the concrete Cauchy estimate as the
remaining analytic input while making it directly consumable by the finite-HLS
capstone wrappers.
