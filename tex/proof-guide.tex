...
complex disc of explicit radius \(\sqrt{2}/(|J||E|)\) at \(h=0\). Closes the
Cauchy-route at the per-fixed-volume level unconditionally; volume-uniform
requires sharper connected-correlation Q-bounds (cluster expansion).
