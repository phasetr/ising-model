...
\(\langle\sigma_i\sigma_j\rangle^\infty\le(\beta J\,2d)^2\).  The same reverse-triangle
step continues while the separation from \(j\) stays \(\ge2\); the obstruction is the
