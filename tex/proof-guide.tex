...
ferromagnetic high-temperature pairs ($0<d$, $0<J$, $0<\beta$, $1\le\alpha$,
...
\item every admissible decay rate $a$ satisfies $a\le -\log(\tanh(\beta J))$
  (the high-temperature all-rate cap, transferred to an arbitrary exhaustion).
\end{itemize}
...
high-temperature active pair $(x,z)$,
\[
