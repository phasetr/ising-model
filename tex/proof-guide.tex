...
\texttt{Metric.eventually\_nhds\_iff\_ball}. The radius \(r\) depends on
\(G\) and \(J\); volume-uniformity is the next step toward the volume-uniform
\(Z_{\mathbb{C}}\) lower bound (Issue \#3044).
\end{theorem}
