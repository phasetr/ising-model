...
remains supplied by
\texttt{LeeYangClosedBallPointwiseNormalisedEventualOverlapBranchData}.
...
\end{Verbatim}
in \texttt{Concrete/LatticeGraphCorrelation/PerStageComplex.lean}.  This
records the closed-ball analogue of the deviation-to-local-bound
triangle-inequality route for the eventual-overlap boundary.  It still does
not construct eventual-overlap data, prove closed-ball containment, or prove
