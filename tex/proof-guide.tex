...
\(0\le\beta J\,2d<1\).  Naive single-vertex peeling does \emph{not} iterate to a
genuine distance decay (at distance \(2\) it still only yields \(\beta J\,2d\),
and no \(\le\beta J\,2d\) bound holds for adjacent pairs); prefactor-free
