...
telescope to \(\langle\sigma_x\sigma_z\rangle^\infty-\langle\sigma_x\sigma_z\rangle_{\Lambda_0}\),
hence are summable (\texttt{correlationAlongExhaustion\_increment\_summable}).
