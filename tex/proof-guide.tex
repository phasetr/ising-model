...
(\texttt{tsum\_truncated2Infinite\_prod\_decay\_of\_high\_temp}), the boundary-sum
ingredients for the finite-volume\(\to\)infinite-volume convergence-rate coupling
(Issue \#2965).
