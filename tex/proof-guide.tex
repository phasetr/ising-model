...
\(\langle\sigma_i\sigma_j\rangle^\infty\le(\beta J\,2d)^2\).  At distance \(2\),
however, naive single-vertex peeling does \emph{not} iterate (it still only yields
\(\beta J\,2d\), and no \(\le\beta J\,2d\) bound holds for adjacent pairs); prefactor-free
