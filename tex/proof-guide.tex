...
($|U_4^\infty|$ uniform $m^-_\inf$ bound; GJ \S4.3 Cor 4.3.3 + \S17.5 p.~312; Issue \#1645
Step 119 plan Step 5.5a)]
Given a uniform positive lower bound $m_\inf$ on the 4 per-pair pseudo-masses
$m^-_{0s}, m^-_{ru}, m^-_{0u}, m^-_{rs}$ with $0 < m_\inf$:
\[
  |U_4^\infty(0, r, s, u)| \le \frac{8}{r'^{2\alpha}\cdot m_\inf^{2\alpha}}.
\]
Each per-pair $1/m^{-\alpha}$ is bounded by $1/m_\inf^\alpha$ via
