...
infinite-HLS bridge interface.  Thirty entry points feed
...
\texttt{DerivativeLimitProviderCauchyHLS.lean} packages eighteen entry points
that
...
\texttt{DerivativeLimitProviderDiniHLS.lean} packages eighteen entry points
that
