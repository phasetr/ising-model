...
This is the component-factorization core: it identifies the correlation of a
bond-deleted system on a fully separated region with the correlation of the
isolated component, the bridge needed to translate the bond-deletion increment
(\texttt{correlation\_sub\_deleteEdges\_le\_derivBound}) into a finite-volume
exhaustion-stage increment.
