...
\begin{theorem}[\texttt{freeEnergy\_monotone\_h}]
The free energy $f(h) = |\iota|^{-1}\ln Z(h)$ is monotone increasing
in $h$ on $[0,\infty)$. Immediate from $Z(h_2) \ge Z(h_1) > 0$ and
the monotonicity of $\ln$ (\texttt{Real.log\_le\_log}).
\end{theorem}
