...
\texttt{AmbientLattice/Analyticity.lean}.
...
remain in \path{IsingModel/AmbientLattice/Analyticity.lean}.
...
with the concrete $\mathbb{Z}^d$ $\Lambda$-, cubic-, and along-exhaustion
wrappers in
...
monotonicity, h-symmetry, absolute-field, and bottom-graph comparison wrappers
now live in
...
{\raggedright
The concrete $\mathbb{Z}^d$ direct finite-volume partition-function wrappers
now live in
...
\texttt{Concrete/LatticeGraphCorrelation}; the $\Lambda$-layer wrappers remain
...
PR~\#1882); the $\Lambda$-layer wrappers remain in the existing
\texttt{Analyticity.lean} module.
...
\texttt{AmbientLattice/SpecialCases} and
\texttt{Concrete/LatticeGraphCorrelation} (moved from the legacy modules in
PR~\#1881); the $\Lambda$-layer wrappers remain in the existing
\texttt{Analyticity.lean} module.
...
(moved from the legacy modules in PR~\#1880).
...
(moved from the legacy modules in PR~\#1879).
