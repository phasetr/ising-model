...
\begin{theorem}[GJ \S 5.1 cluster property --- $J = 0$ instance;
PR \#207]
...
\]
The factorisation is \emph{exact at every separation}, not just
asymptotic.
\end{theorem}

\begin{proof}
By \texttt{correlation\_J\_zero}
(Glimm--Jaffe \cite{glimm-jaffe} style, essentially the
non-interacting free-spin model), for any subset
$A \subseteq \iota$,
...
Reference: Glimm--Jaffe \cite{glimm-jaffe} \S 5.1, pp.~76--77. This
is the trivial non-interacting instance of the cluster property;
non-zero-$J$ decay at large separation remains follow-up work.
\end{proof}
