...
(Issue~\#780, research-level). The link to PR~\#792's
$\mathrm{clusterProperty}$ predicate (exponential decay with
$\alpha > 0$ implies the cluster property) is deferred to a
follow-up PR.
