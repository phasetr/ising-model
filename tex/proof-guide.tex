...
\(C_k:=C\) (constant). Matches the typical scenario where axiom-free
Simon-Lieb gives geometric real-axis decay and Cauchy estimate gives a
stage-uniform Lipschitz constant.
