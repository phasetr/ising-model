...
| refactor cycle 7 (wire 68 umbrella-detached modules) | #4553 | **OPEN** | Cycle 7 tracking issue: wire 68 W-class modules (8312 lines, doc-cited DONE content) into root umbrella `IsingModel.lean` (additive import lines only, within standing B4 authorization). Triage basis: `.self-local/reports/issue-manager-triage-77modules-2026-07-17.md` (W68/P11+1/D0). Branch: `refactor/c7-wire-detached-modules-2026-07-17` (PR #4554, draft); gates: zero-warning build, GKSTest, audit_gate --full, dev-review+codex, tier1+issue-manager, CI green. | `4553.md` |
| umbrella-detached modules triage (Finding 2 resolved) | — | **TRIAGED (2026-07-17, dev-issue-manager)**: 80 detached modules (9893 lines, independently re-derived) reachable-closure-checked — 68 modules/8312 lines **W (keep-and-wire, cycle-7 additive PR, LOW risk)**; 11 modules/1454 lines (`PseudoMass.FromParams*`) **P (parked #2965, no citations, leave detached)**; 1 module/127 lines (`TestGenerators`) correctly detached-by-design (test-lib only); **0 D (deletion) candidates** — no module lacked a genuine book citation or math-value claim on inspection; the tier2 report's "some superseded" hedge for ClusterExpansion Mayer bits did not hold on verification. No user decision needed for D (none exist); P requires no action; W is cycle-7 work (issue #4553). Full record: `.self-local/reports/issue-manager-triage-77modules-2026-07-17.md`. | — |
