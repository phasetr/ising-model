...
| refactor cycle 7 (wire 68 umbrella-detached modules) | #4553 | **CLOSE-READY completed (2026-07-17)** | 66/68 W-class modules wired into `IsingModel.lean` (PR #4554, HEAD `e6168ede`); 2 build-forced reverted on a genuine duplicate declaration (`IsingModel.mayerExpansionTerm_eq_zero_of_no_polymers` declared identically in `ClusterExpansion/MayerCore/Truncations.lean:84` and reachable `ClusterExpansion/StrictPositivity/CycleSeven.lean:47`) — triage's line-39 "verified NOT superseded" claim for this pair was WRONG, corrected in report addendum. Deliverable discharged (66/68 wired, build-verified exclusions documented); P-class (11) + TestGenerators untouched, 0 deletions. All gates PASS. Outcome recorded: `.self-local/issues/4553.md`, GH comment https://github.com/phasetr/ising-model/issues/4553#issuecomment-5001607668. | `4553.md` |
