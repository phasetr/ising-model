# ローカルミラー・インデックス (2026-07-17 更新 — #4506/#4519/#4535/#4538/#4541/#4544 CLOSED completed (refactor cycles 1-4))
...
| refactor cycle 5 (umbrella-to-child import downgrades) | #4547 | **OPEN (2026-07-17)** | User-authorized umbrella→child import downgrade campaign (668 repo-internal + 298 coupled chains). Shake-candidate-driven selection, batched builds (shake = candidate-only; build = arbiter), per-file revert rule. Acceptance gates: zero-warning build, GKSTest, audit_gate V1/V2/V3, CI green, umbrella-file integrity. Out of scope: umbrella deletion, lakefile, proof content, #4533/#4520/H2-hook/BAN LIST. Design: `.self-local/reports/design-refactor-c5-2026-07-17.md` (design in progress, may span sessions). Branch: `refactor/c5-umbrella-child-downgrades-2026-07-17`; PR #4548 (draft). | `4547.md` |
