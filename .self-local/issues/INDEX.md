...
| refactor cycle 3 (shake-imports + CI audit gate) | #4541 | **OPEN** | shake-driven removals/downgrades + CI audit_gate.py (V1/V2/V3); user-authorized via re-issued /goal, dev-issue-manager adjudicated in-scope; PR #4542 (branch `refactor/c3-shake-and-ci-gate-2026-07-17`) | `4541.md` |
