...
| refactor M1 (file splits) | #4538 | **OPEN** | M1 umbrella split cycle (2026-07-17): MayerMontroll→3 children, LayerPerronExistence→5 children, remove `pseudoMass_deriv_formula_corollary`, add shake config. PR #4539 Draft. Design: `.self-local/reports/design-refactor-m1-2026-07-17.md` | `4538.md` |
