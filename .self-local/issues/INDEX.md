...
| refactor cycle 5 (umbrella-to-child import downgrades) | #4547 | **OPEN, close-on-merge (2026-07-17)** | Phase A DONE (626 files, 1584→759 import lines, ~46 FP reverts, all gates PASS, umbrella integrity + scope guard verified). Phase B (298 coupled chains) unviable-as-designed, deferred (non-converging cascade); NOT carried forward as open scope — reopen only via a fresh Phase-B design/issue. `Closes #4547` in PR #4548 is correct. Branch: `refactor/c5-umbrella-child-downgrades-2026-07-17`; PR #4548 (draft). Handoff: `.self-local/reports/handoff-4547-2026-07-17.md`. | `4547.md` |
