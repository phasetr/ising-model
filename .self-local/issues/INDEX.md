# ローカルミラー・インデックス (2026-07-22 更新 — #4635 CLOSED (merged PR #4652, squash 02f29334), #4653 OPEN (PR #4652 follow-up), #4646 OPEN, #4639 CLOSED (mirror was stale at OPEN, corrected), #4640 CLOSED, #4642 OPEN, #4649 OPEN (pending CI), #4650 CLOSED (merged PR #4651, squash 58f4e1f0))
