# ローカルミラー・インデックス (2026-07-15 更新 — #4519 Rev22 STATIC_AUDIT_FAIL / RETIRED)
...
**新規セッション再開手順**: `docs/index.md` の GJ §17-18 進捗表を読む → git log で main hash 確認 → open issue #4519/#4506 で benchmark gate を確認 → closed issue (#4386/#4413/#4418/#4433/#4405/#4499/#4501/#4503/#4504 など) で背景・parking/decline/completion 理由を確認。再開ステップは `docs/index.md` 本体に記載。
...
| build-speed benchmark (R1/R2/R5) | #4519 | **OPEN — Rev22 STATIC_AUDIT_FAIL/retired; fresh Rev23 required** | Rev22 immutable; no build/measurement/freeze/results/metrics. Measurement pending; no metrics verdict. [checkpoint](https://github.com/phasetr/ising-model/issues/4519#issuecomment-4979750222) | `4519.md` |
| refactor phase tracker | #4506 | **OPEN — R1-R7 resolved; #4519 Rev22 retired** | Fresh Rev23 requires separate authority; no measurement or metrics verdict. [backlink](https://github.com/phasetr/ising-model/issues/4506#issuecomment-4979751432) | `4506.md` |
